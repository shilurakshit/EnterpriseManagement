...
//
//Get Token from request(GET request) header
//Validate Token
...
//        }
        ...
        // if username is not null that means someone added username and SecurityContextHolder.getContext().getAuthentication() == null that means that user is not authenticated then set the authentication.
